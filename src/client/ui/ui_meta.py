...
class jcb_1_gold:
    badge_anim = cres.badges.jcb_gold
...
class jcb_1_silver:
    badge_anim = cres.badges.jcb_silver
...
class jcb_1_bronze:
    badge_anim = cres.badges.jcb_bronze
...
class dsb_1_gold:
    badge_anim = cres.badges.dsb_gold
...
class dsb_1_silver:
    badge_anim = cres.badges.dsb_silver
...
class dsb_1_bronze:
    badge_anim = cres.badges.dsb_bronze
