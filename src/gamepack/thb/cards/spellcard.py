...
from ..actions import random_choose_card, register_eh, migrate_cards, user_input_action
...
class RejectHandler(EventHandler):
    def handle(self, evt_type, act):
        if evt_type == 'action_before' and isinstance(act, SpellCardAction):
            ...
            rst = user_input_action(self, action, pl, ('cards', 'showncards'), [])
...
class DollControl(InstantSpellCardAction):
    def apply_action(self):
        ...
        action = user_input_action(self, action, ['cards', 'showncards'], g.players)
