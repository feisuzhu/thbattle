...
card_definition = [
    ...
    (SuwakoHatCard, Card.HEART, 1),
    (WitchBroomCard, Card.HEART, 1),
    (ScarletRhapsodySwordCard, Card.HEART, 1),
    (TridentCard, Card.HEART, 1),
    (HakuroukenCard, Card.HEART, 1),
    (HarvestCard, Card.HEART, 1),
    (DonationBoxCard, Card.HEART, 1),
    (WineCard, Card.HEART, 1),
