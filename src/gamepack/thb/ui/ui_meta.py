...
class Flandre:
    ...
    description = (
        ...
        u'|G狂咲|r：在你的摸牌阶段，如果你选择只摸一张牌，那么在你的出牌阶段你可以出任意张【弹幕】，并且【弹幕】和【弹幕战】的伤害为2点，但是不能连续对同一目标打出两张【弹幕】。'
    )
...
class Eirin:
    ...
    description = (
        ...
        u'|G急救|r：当任意人进入濒死状态时，你可以将你的任意红色牌当做【麻薯】使用。'
    )
...
class Suika:
    ...
    description = (
        ...
        u'|G酒鬼|r：你的出牌阶段，你可以将任意黑色牌当【酒】使用。\n\n'
