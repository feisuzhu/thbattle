...
class Qiliao:
    ...
    def is_action_valid(g, cl, target_list):
        skill = cl[0]
        if not 0 < len(skill.associated_cards) <= 3:
            return False, u'气疗：请选择至多3张牌放置在人物牌上'

        return True, u'发动气疗'

    def effect_string(act):
        # for LaunchCard.ui_meta.effect_string
        return u'|G【%s】|r发动了|G气疗|r'
...
class Meirin20150714:
    ...
    description = (
        u'|DB华人小娘 红美铃 体力：4|r\n\n'
        u'|G气疗|r：出牌阶段限一次，你可以将至多三张牌背面朝上置于你的武将牌上，称为“气”。其他角色的出牌阶段开始时，该角色可以弃置一张|G弹幕|r，将一张“气”置入弃牌堆。你的回合开始时，若你有“气”，你令一名角色获得所有“气”并令其回复1点体力。\n\n'
        u'|DB（人物设计：罗妲.坂井）|r'
    )
