...
class HopeMask:
    # Skill
    name = '希望之面'
    description = '出牌阶段开始时，你可以观看牌堆顶的1+X张牌，然后展示并获得其中任意数量的同花色牌，其余的牌以任意顺序置于牌堆顶。（X为你已损失的体力）'
...
class HopeMaskKOF:
    # Skill
    name = '希望之面'
    description = '出牌阶段开始时，你可以观看牌堆顶的X+1张牌，然后展示并获得其中一张牌，其余的牌以任意顺序置于牌堆顶。（X为你已损失的体力）'
...
class DarkNoh:
    description = '出牌阶段限一次，你可以将一张黑色牌置于体力不小于你的其他角色的明牌区，然后其须弃置除获得的牌以外的手牌，直到手牌数与体力相等。'
...
class DarkNohKOF:
    description = '<style=B>限定技</style>，出牌阶段，你可以将一张黑色牌置于体力不小于你的其他角色的明牌区，然后其须弃置除获得的牌以外的手牌，直到手牌数与体力相等。'
