...
class KeineGuard:
    ...
    description = (
        ...
        '<style=Desc.Li><style=Skill.Name>决意</style>：当你受到伤害时，若同样拥有<style=Skill.Name>决意</style>的另一名角色的体力比你高，则伤害改为由该角色承受。同样拥有<style=Skill.Name>决意</style>的另一名角色于你的回合内回复体力时，你回复相同的体力。</style>'
    )
...
class Devoted:
    ...
    name = u'决意'
    description = (
        '当你受到伤害时，若同样拥有<style=Skill.Name>决意</style>的另一名角色的体力比你高，则伤害改为由该角色承受。同样拥有<style=Skill.Name>决意</style>的另一名角色于你的回合内回复体力时，你回复相同的体力。'
    )
